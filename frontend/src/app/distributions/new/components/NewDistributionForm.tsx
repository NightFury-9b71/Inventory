...
export default function NewDistributionForm({
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Distribute Item</CardTitle>
      </CardHeader>
      <CardContent>
        {error && (
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="flex gap-2 pt-4 border-t">
            <Button type="submit" disabled={saving || distribution.itemId === 0 || distribution.officeId === 0}>
              <Save className="h-4 w-4 mr-2" />
              {saving ? "Distributing..." : "Distribute Item"}
            </Button>
